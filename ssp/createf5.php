...
<head>
  ...
  <title>F5 Self Service Portal</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Self Service Portal</span>
    </a>
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Relax as we are setting up F5...</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <?php
